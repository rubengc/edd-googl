...
Once activated, EDD Googl will generate a Goo.gl URl when you saves a published download (include from Frontend Submission plugin). Also, has a function to update all shortened urls.

For developers, you could use `edd_googl_shortlink()` to easily get a download shortlink.
